...
class Dht_sensor_server(NeuronModule):
    def __init__(self, **kwargs):
        ...
        if self._is_parameters_ok():
            ...
            nilai1 = str(humidity)
            nilai2 = str(temperature)
            content =http.request("http://xxx.xxx.xxx.xxx/datasensor/terimasuhu.php?sensor1="+nilai1+"&sensor2="+nilai2, method="GET")[1]
